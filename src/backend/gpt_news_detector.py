...
class GPTNewsDetector:
    ...
    def __init__(self):
        """Initialize OpenAI client following official documentation"""
        ...
        # Get API key from environment - official recommendation
        import os
        ...
        try:
            ...
            # Use latest GPT-4o model as recommended
            self.model = "gpt-4o"
    ...
    def _test_connection(self):
        """Test OpenAI connection with simple request"""
        try:
